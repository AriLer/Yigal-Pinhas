...
const bookRoutes = [
  "המדריך-השלם-לפעילות-בחדר-הכושר",
]
  ...
  return (
      <Router>
        ...
        <Routes>
            ...
            <Route path={`/מאמרים/${paperRoutes[0]}`} element={<Navigate to="/מאמרים/0" />}/>
            <Route path={`/מאמרים/${paperRoutes[1]}`} element={<Navigate to="/מאמרים/1" />}/>
            <Route path={`/מאמרים/${paperRoutes[2]}`} element={<Navigate to="/מאמרים/2" />}/>
