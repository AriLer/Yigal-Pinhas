...
const Papers = () => {
  ...
  const handleSearch = (e) => {
    ...
    setFilteredPapers(papers.filter(paper => paper.name.includes(e.target.value)))
  }
  ...
  return (
    ...
    <h2>מאמרים</h2>
    <SearchContainer>
      <input value={searchQuery} id="search" onChange={handleSearch} placeholder="חפש מאמר..." />
    </SearchContainer>
    <ListContainer>
      {filteredPapers.length === 0 && <NotFoundText> לא נמצא מאמר בשם זה</NotFoundText>}
